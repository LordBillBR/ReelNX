...
std::unordered_map<AppConfig::Item, AppConfig::Option> AppConfig::settingMap = {
    ...
    {STREMIO_ONBOARDING_DONE, {"stremio_onboarding_done"}},
...
bool AppConfig::init() {
    ...
    // 初始化是否固定显示底部进度条
    MPVCore::BOTTOM_BAR = this->getItem(PLAYER_BOTTOM_BAR, false);
    ...
    brls::Application::getWindowCreationDoneEvent()->subscribe([this]() {
        ...
        // 初始化主题
        // Default to dark: the ReelNX screens paint a dark ocean backdrop, so
